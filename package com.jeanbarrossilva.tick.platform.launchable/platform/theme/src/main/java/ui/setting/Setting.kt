package com.jeanbarrossilva.samm.platform.theme.ui.setting
...
import com.jeanbarrossilva.samm.platform.theme.SammTheme
import com.jeanbarrossilva.samm.platform.theme.extensions.EmptyMutableInteractionSource
import com.jeanbarrossilva.samm.platform.theme.extensions.forwardsNavigationArrow
import com.jeanbarrossilva.samm.platform.theme.extensions.`if`
...
fun Setting(
    ...
    containerColor: Color = SammTheme.colorScheme.surfaceVariant,
    ...
    Button(
        ...
        contentPadding = PaddingValues(SammTheme.spacings.medium),
        ...
        ProvideTextStyle(textStyle.copy(color = contentColor)) {
            Row(
                ...
                Column(verticalArrangement = Arrangement.spacedBy(SammTheme.spacings.extraSmall)) {
                    ProvideTextStyle(
                ...
                Spacer(Modifier.width(SammTheme.spacings.medium))
                action()
            }
        }
    }
...
private fun Setting(label: (@Composable () -> Unit)?, modifier: Modifier = Modifier) {
    Setting(
        text = { Text("Setting") },
        action = { Icon(SammTheme.Icons.forwardsNavigationArrow, contentDescription = "Navigate") },
        onClick = { },
        modifier,
        label = label
    )
