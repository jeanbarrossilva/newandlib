package com.jeanbarrossilva.newandlib.project.type.app.structure.platform.theme.children.main.ui

import com.jeanbarrossilva.newandlib.project.Project
import com.jeanbarrossilva.newandlib.project.type.app.structure.platform.theme.children.main.ui.setting.SettingFile
import com.jeanbarrossilva.newandlib.project.type.app.structure.platform.theme.children.main.ui.setting.SettingGroupDirectory
...
internal class SettingDirectory(root: Path, project: Project) : Directory() {
    override val path = root + at("setting")
