package com.jeanbarrossilva.newandlib.project.type.app.structure.theme.children.main.ui.setting.group

import com.jeanbarrossilva.newandlib.project.Project
import com.jeanbarrossilva.newandlib.tool.file.TextFile
import java.nio.file.Path

internal class SettingGroupScopeFile(override val parentPath: Path, project: Project) : TextFile() {
    override val name = "SettingGroupScope.kt"
    override val text = """
