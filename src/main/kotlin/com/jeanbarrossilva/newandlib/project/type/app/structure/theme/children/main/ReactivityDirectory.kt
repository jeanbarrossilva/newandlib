...
import com.jeanbarrossilva.newandlib.project.type.app.structure.theme.children.main.reactivity.OnBottomAreaAvailabilityChangeListenerFile
...
internal class ReactivityDirectory(root: Path, project: Project) : Directory() {
    override val path = root + at("reactivity")
