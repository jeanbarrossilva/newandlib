package com.jeanbarrossilva.newandlib.project.type.app.structure.platform.theme.children.main.configuration

import com.jeanbarrossilva.newandlib.project.Project
import com.jeanbarrossilva.newandlib.tool.file.TextFile
import java.nio.file.Path

internal class SpacingsFile(override val parentPath: Path, project: Project) : TextFile() {
    override val name = "Spacings.kt"
    override val text = """
